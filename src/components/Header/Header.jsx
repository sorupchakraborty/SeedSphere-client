  ...
  const links = (
    <>
      <NavLink
        to="/"
        className={({ isActive }) =>
          `px-4 py-2 md:text-sm lg:text-md font-semibold rounded-lg mr-2 ${isActive ? 'bg-rose-600 text-white' : 'bg-transparent dark:text-gray-200'
          }`
        }
      >
        Home
        ...
        <div className="navbar-end gap-2">
          {
            <NavLink
              ...
              className={({ isActive }) =>
                `px-4 py-2 md:text-sm lg:text-md font-semibold rounded-lg ${isActive ? 'bg-rose-600 text-white' : 'bg-transparent dark:text-gray-200'
                }`
              }>
